...
export function InviteLayout3(p: InvitePageViewModel) {
  return (
    <main className="relative flex min-h-0 flex-1 flex-col overflow-hidden bg-zinc-950 text-stone-200">
      ...
      {p.coverUrl ? (
        <div className="relative z-[1] h-52 w-full shrink-0 overflow-hidden sm:h-72">
        ...
        <div className="relative z-[1] h-32 w-full shrink-0 overflow-hidden sm:h-40" aria-hidden>
